    ...
    <section className="bg-custom-bg2">
      <div className="container py-10 relative w-full">
        <div className="flex items-center justify-between mb-6 gap-3 max-w-fit relative">
          ...
          >
            <button className="hidden lg:block text-custom-pri text-[20px]">ⓘ</button>
            {isHovered && (
        ...
        >
          ...
          <button className="custom-prev2 hidden sm:flex absolute left-0 top-1/2 -translate-y-1/2 z-10 w-[42px] h-[42px] border-1 border-custom-pri bg-white text-custom-pri rounded-md text-xl items-center justify-center">
            <MdArrowBackIos className="relative left-[3px]" />
          </button>
          <button className="custom-next2 hidden sm:flex absolute right-0 top-1/2 -translate-y-1/2 z-10 w-[42px] h-[42px] border-1 border-custom-pri bg-white text-custom-pri rounded-md text-xl items-center justify-center">
            <MdArrowForwardIos />
          </button>
        </Swiper>
      </div>
